...
sub _reset_fix_free_cash_context {
    ...
    $context->{contract_balances} = NGCP::BulkProcessor::Dao::Trunk::billing::contract_balances::findby_contractid($context->{db},$contract_id);
    ...
    foreach my $balance (sort NGCP::BulkProcessor::Dao::trunk::billing::contract_balances::sort_by_end_desc
        ...
        my $mapping = NGCP::BulkProcessor::Dao::Trunk::billing::billing_mappings::findby_contractid_ts($context->{db},$contract_id,$balance ->{_start})->[0];
    ...
    my $mapping = GCP::BulkProcessor::Dao::Trunk::billing::billing_mappings::findby_contractid_ts($context->{db},$contract_id,$balances[0]->{_start});
    ...
    use NGCP::BulkProcessor::Dao::Trunk::billing::contract_balances qw();
NGCP::BulkProcessor::Dao::Trunk::billing::billing_mappings::findby_contractid_ts($contract_id)
