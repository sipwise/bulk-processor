package NGCP::BulkProcessor::Projects::Massive::CDRGenerator::Generator;
use strict;
...
use NGCP::BulkProcessor::Projects::Massive::CDRGenerator::Settings qw(
    $dry
    $skip_errors
...
use NGCP::BulkProcessor::Utils qw(); #qw(create_uuid threadid timestamp stringtobool check_ipnet trim);
