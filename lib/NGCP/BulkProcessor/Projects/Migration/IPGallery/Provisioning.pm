...
sub _create_subscriber {
    ...
    $context->{cli_preference_id} = NGCP::BulkProcessor::Dao::Trunk::provisioning::voip_usr_preferences::insert_row($context->{db},
        attribute_id => $context->{cli_attribute}->{id},
    ...
    $context->{allowed_clis_preference_id} = NGCP::BulkProcessor::Dao::Trunk::provisioning::voip_usr_preferences::insert_row($context->{db},
        attribute_id => $context->{allowed_clis_attribute}->{id},
        subscriber_id => $context->{provisioning_subscriber_id},
        value => $context->{cli},
    );
