package NGCP::BulkProcessor::Projects::Migration::CommunicationConcept::Provisioning;
use strict;
...
sub copy_contracts {
    ...
    return ($result && NGCP::BulkProcessor::Dao::mr38::billing::contracts::process_records_source(
        source_db => \&get_source_billing_db,
...
sub _copy_contract {
    ...
    return 0 unless _copy_contract_init_context($context);
