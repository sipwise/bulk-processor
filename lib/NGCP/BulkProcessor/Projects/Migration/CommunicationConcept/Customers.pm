...
sub copy_customers {
    ...
    return ($result && NGCP::BulkProcessor::Dao::mr341::billing::contracts::source_process_records(
        source_dbs => {
...
sub _copy_contract {
    ...
    return 0 unless _copy_contract_init_context($context,$contract);
...
sub _copy_contract_init_context {
    ...
    $contract->{product_id} = $context->{sip_account_product}->{id};
