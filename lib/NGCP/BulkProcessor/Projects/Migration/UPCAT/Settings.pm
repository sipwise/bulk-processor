...
our $mta_ignore_subscriber_unique = 0;
...
sub update_settings {
    ...
    if (defined $data) {
        ...
        $mta_ignore_subscriber_unique = $data->{mta_ignore_subscriber_unique} if exists $data->{mta_ignore_subscriber_unique};
        ...
        $mta_default_billing_profile_name = $data->{mta-default_billing_profile_name} if exists $data->{mta_default_billing_profile_name};
        $mta-default_barring = $data->{mta_default_barring} if exists $data->{mta_default_barring};
