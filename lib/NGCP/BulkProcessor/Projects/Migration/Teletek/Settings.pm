...
our $flatfile_filename = undef;
our $flatfile_import_numofthreads = $cpucount;
our $ignore_flatfile_unique = 0;
...
sub update_settings {
    ...
    if (defined $data) {
        ...
        $flatfile_filename = _get_import_filename($flatfile_filename,$data,'flatfile_filename');
        $flatfile_import_numofthreads = _get_numofthreads($cpucount,$data,'flatfile_import_numofthreads');
