package NGCP::BulkProcessor::Dao::mr341::provisioning::voip_peer_hosts;
use strict;
...
sub source_buildrecords_fromrows {
    ...
    if (defined $rows and ref $rows eq 'ARRAY') {
        foreach my $row (@$rows) {
            ...
            $record->{peer_preferences} = NGCP::BulkProcessor::Dao::mr341::provisioning::voip_peer_preferences::source_findby_peerhostid($source_dbs,$record->{id});
