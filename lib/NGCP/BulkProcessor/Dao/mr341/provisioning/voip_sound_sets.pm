package NGCP::BulkProcessor::Dao::mr341::provisioning::voip_sound_sets;
use strict;
...
use NGCP::BulkProcessor::Dao::mr341::provisioning::voip_sound_files qw();
...
sub source_buildrecords_fromrows {
    ...
    if (defined $rows and ref $rows eq 'ARRAY') {
        foreach my $row (@$rows) {
            ...
            # transformations go here ...
            $record->{sound_files} = NGCP::BulkProcessor::Dao::mr341::provisioning::voip_sound_files::source_findby_setid($source_dbs,$record->{id});
