package NGCP::BulkProcessor::Dao::mr553::billing::domains;
use strict;
...
sub source_buildrecords_fromrows {
    ...
    if (defined $rows and ref $rows eq 'ARRAY') {
        foreach my $row (@$rows) {
            ...
            $record->{voip_dom_preferences} = NGCP::BulkProcessor::Dao::mr553::provisioning::voip_dom_preferences::source_findby_domain($source_dbs,$record->{domain});
