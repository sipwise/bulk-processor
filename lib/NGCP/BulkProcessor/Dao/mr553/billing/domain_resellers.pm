package NGCP::BulkProcessor::Dao::mr553::billing::domain_resellers;
use strict;
...
use NGCP::BulkProcessor::Dao::mr553::billing::domains qw();
...
sub source_buildrecords_fromrows {
    ...
    if (defined $rows and ref $rows eq 'ARRAY') {
        foreach my $row (@$rows) {
            ...
            $record->{domain} = NGCP::BulkProcessor::Dao::mr553::billing::domains::source_findby_id($source_dbs,$record->{domain_id});
