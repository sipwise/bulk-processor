package NGCP::BulkProcessor::Dao::mr553::provisioning::voip_cf_source_sets;
use strict;
...
use NGCP::BulkProcessor::Dao::mr553::provisioning::voip_cf_sources qw();
...
sub source_buildrecords_fromrows {
    ...
    if (defined $rows and ref $rows eq 'ARRAY') {
        foreach my $row (@$rows) {
            ...
            # transformations go here ...
            $record->{sources} = NGCP::BulkProcessor::Dao::mr553::provisioning::voip_cf_sources::source_findby_sourcesetid($source_dbs,$record->{id});
