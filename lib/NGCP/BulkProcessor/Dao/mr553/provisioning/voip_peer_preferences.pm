package NGCP::BulkProcessor::Dao::mr553::provisioning::voip_peer_preferences;
use strict;
...
sub source_findby_peerhostid {

    my ($source_dbs,$peer_host_id) = @_;
