package NGCP::BulkProcessor::Downloaders::IMAPAttachmentDownloader;
use strict;
...
require Exporter;
our @ISA = qw(Exporter NGCP::BulkProcessor::AttachmentDownloader);
our @EXPORT_OK = qw();
...
sub new {
    ...
    my $self = NGCP::BulkProcessor::AttachmentDownloader->new($class,$server,$ssl,$user,$pass,$foldername,$checkfilenamecode,$download_urls);
